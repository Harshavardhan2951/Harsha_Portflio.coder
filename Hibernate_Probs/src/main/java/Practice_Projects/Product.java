...
throws ServletException, IOException {
	...
	Connection con =
	DriverManager.getConnection("jdbc:mysql://localhost:3306/pets","root","Harsha2001$");
	Statement st = con.createStatement();
	st.executeUpdate("use pets");
	int res = st.executeUpdate("insert into pets.products(id,name,color,pricecost)values('"+id_int+"','"+name+"','"+color+"','"+price_cost+"')");
